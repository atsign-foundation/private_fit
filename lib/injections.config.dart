...
import 'application/activity_tracker/bloc/pedometer_bloc.dart' as _i39;
...
import 'domain/activity_tracker/i_activity_tracker_facade.dart' as _i6;
import 'domain/activity_tracker/use_cases/get_fetched_step_use_case.dart'
    as _i20;
import 'domain/activity_tracker/use_cases/pedestrian_status_use_case.dart'
    as _i27;
import 'domain/activity_tracker/use_cases/steps_count_stream_use_case.dart'
    as _i30;
...
import 'infrastructure/activity_tracker/pedometer_facade.dart' as _i7;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i6.IActivityTrackerFacade>(
      () => _i7.ActivityTrackerServices());
  ...
  gh.lazySingleton<_i20.InitPedometerUseCase>(
      () => _i20.InitPedometerUseCase(get<_i6.IActivityTrackerFacade>()));
  gh.factory<_i21.LoadAtClientPreferenceUseCase>(() =>
      _i21.LoadAtClientPreferenceUseCase(get<_i8.IAtsignOnBoardingFacade>()));
  ...
  gh.lazySingleton<_i27.PedestrianStatusUseCase>(
      () => _i27.PedestrianStatusUseCase(get<_i6.IActivityTrackerFacade>()));
  ...
  gh.lazySingleton<_i30.StepsCountStreamUseCase>(
      () => _i30.StepsCountStreamUseCase(get<_i6.IActivityTrackerFacade>()));
  gh.factory<_i31.AtContactInitializationUseCase>(
      () => _i31.AtContactInitializationUseCase(get<_i10.IContactsFacade>()));
  gh.factory<_i32.GetActiveAtsignUseCase>(
      () => _i32.GetActiveAtsignUseCase(get<_i10.IContactsFacade>()));
  gh.factory<_i33.GetFetchedFood>(
      () => _i33.GetFetchedFood(get<_i16.IOpenFoodFactsFacade>()));
  gh.lazySingleton<_i34.GetMenstrualDataUseCase>(
      () => _i34.GetMenstrualDataUseCase(get<_i14.IMenstrualFacade>()));
  gh.factory<_i35.GetOnBoardedAtSignUseCase>(
      () => _i35.GetOnBoardedAtSignUseCase(get<_i8.IAtsignOnBoardingFacade>()));
