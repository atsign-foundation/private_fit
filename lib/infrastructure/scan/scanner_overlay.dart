...
import 'package:private_fit/infrastructure/scan/animations/smooth_reveal_animation.dart';
import 'package:private_fit/infrastructure/scan/continuous_scan_model.dart';
import 'package:private_fit/infrastructure/scan/scan_header.dart';
    ...
    return LayoutId(
      ...
      child: const SmoothRevealAnimation(
        ...
        child: Padding(
          ...
          child: AutoSizeText(
            'SmoothProductCarousel(containSearchCard: true,),',
          ),
        ),
      ),
    );
