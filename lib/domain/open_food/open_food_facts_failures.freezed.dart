...
part of 'open_food_facts_failures.dart';
...
/// @nodoc
abstract class $OpenFoodFailuresCopyWith<$Res> {
  factory $OpenFoodFailuresCopyWith(
          OpenFoodFailures value, $Res Function(OpenFoodFailures) then) =
      _$OpenFoodFailuresCopyWithImpl<$Res>;
}

/// @nodoc
class _$OpenFoodFailuresCopyWithImpl<$Res>
    implements $OpenFoodFailuresCopyWith<$Res> {
  _$OpenFoodFailuresCopyWithImpl(this._value, this._then);

  final OpenFoodFailures _value;
  // ignore: unused_field
  final $Res Function(OpenFoodFailures) _then;
}
...
class _$_FailedToGetCameraPermissions implements _FailedToGetCameraPermissions {
  ...
  @override
  String toString() {
    return 'OpenFoodFailures.failedToGetCameraPermissions()';
  }
